package com.cityu.forum.domain;
...
public class Blog implements Serializable {
	...
	private String tags;  // 标签:取件/代取

	@Column(name="location", length = 100)
	private String location;  // 分类:取件地点

    @Column(name = "requireTime", nullable = false)
    private Timestamp requireTime; //需求时间
